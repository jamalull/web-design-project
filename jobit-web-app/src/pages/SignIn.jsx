...
export default function SignIn() {
  ...
  const {inputSignIn} = state;
  const {handleInputSignIn, handleSubmitSignIn} = handleFunction;
  ...
  return (
    <>
      <div className=" mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmitSignIn} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
          <div>
            <label htmlFor="email">
              Email Address *
            </label>
