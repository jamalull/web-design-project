    ...
    <>
      <section className="bg-slate-100 py-16">
        ...
        <div>
          ...
          <p className="mb-5 text-sm text-center text-gray-500">Lazada Inc</p>
          <div className="flex justify-center gap-3">
            ...
            <span className="flex items-center gap-1">
              ...
              <p className="mb-1 text-sm text-gray-500">
                Rp 6.000.000 s/d Rp 10.000.000
              </p>
            </span>
          </div>
          <div className="flex justify-center gap-3">
            <span className="flex items-center gap-1">
              ...
              <p className="mb-1 text-sm text-gray-500">
                Published at 2023-06-19 22:07:26
              </p>
            </span>
            <span className="flex items-center gap-1">
              <svg
              ...
              <p className="mb-1 text-sm text-gray-500">
                Updated at 2023-06-19 22:07:26
              </p>
            </span>
          </div>
          <p className="w-32 mt-2 mb-5 mx-auto text-center whitespace-nowrap rounded-full px-3.5 py-1 bg-green-100  text-sm text-green-700">
            Open Hiring
          </p>
        </div>
      ...
      <section>
        <div className="w-1/2 mx-auto mt-10">
          ...
          <p>
            ...
            libero facilis soluta dolores exercitationem? Voluptate quis libero
            modi sint corrupti odio reprehenderit veniam soluta ipsa. Voluptates
            necessitatibus consequatur saepe aspernatur qui dolore amet iusto
            laborum animi eligendi error architecto quidem similique enim, et
            accusantium. Ratione earum porro totam nisi?
          </p>
        </div>
        <div className="w-1/2 mx-auto mt-10">
        ...
        <div className="w-1/2 mx-auto mt-10 mb-32 flex gap-3 items-center">
          ...
          <a
            class="inline-flex items-center gap-2 rounded border-2 border-[#55acee] bg-[#55acee] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#55acee] focus:outline-none focus:ring active:opacity-75"
            href="/twitter"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            class="inline-flex items-center gap-2 rounded border-2 border-[#3b5998] bg-[#3b5998] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-[#3b5998] focus:outline-none focus:ring active:opacity-75"
            href="/facebook"
            target="_blank"
            rel="noreferrer"
          >
