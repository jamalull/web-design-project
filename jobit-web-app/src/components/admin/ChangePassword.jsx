    ...
    <>
      <div className=" mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-lg text-center">
          <h1 className="text-2xl font-bold sm:text-3xl">Change Password Account</h1>
          <p className="mt-4 text-gray-500">
          If you want to create a password that is easy to remember, we provide 
          a change password feature to help you. Don't forget to create a strong 
          password so it's not easily hacked.
          </p>
        </div>
        ...
        <form action="" className="mx-auto mb-0 mt-8 max-w-md space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
              ...
              <label
                className="text-gray-500 text-sm inline-block pl-[0.15rem] hover:cursor-pointer"
                for="checkboxDefault">
                    By creating a new password, you agree to ensure that what you fill in this form is correct and finall.
              </label>
            </div>
          </div>
